...
### Sound & Lighting Design — Yankı Kumpanya
...
High hands-on ability across product code, frontend, backend and realtime flows.
...
Building systems that store, process, automate and expose data reliably.
...
Comfortable taking products from code to running infrastructure.
...
Know-how is not limited to code; I can shape, build, ship and operate products.
...
Practical production knowledge from theatre, lighting systems and physical devices.
